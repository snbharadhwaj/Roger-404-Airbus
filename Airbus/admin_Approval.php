...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="admin_dashboard.php.php">Approval</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        ...
        <table class="table table-striped">
            ...
            <?php
                ...
                $sql = "SELECT DISTINCT * FROM assembly";
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td><button class='btn btn-success' onclick='approveData(\"" . $row['Process_ID'] . "\")'>Approve</button></td>";
                        echo "</tr>";
                    }
                } else {
